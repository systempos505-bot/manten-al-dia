...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-64 shrink-0 flex-col gap-6 bg-gradient-to-b from-slate-900 to-slate-800 p-5 text-white">
      <div className="flex items-center gap-3">
        <div className="grid h-11 w-11 place-items-center rounded-2xl bg-white/10 text-2xl">🚿</div>
